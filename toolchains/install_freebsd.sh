...
sudo pkg install -y autoconf automake curl gcc git gmake node012 npm012 postgresql95-server postgresql95-contrib python security/ca_root_nss wget unzip
