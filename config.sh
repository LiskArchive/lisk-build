...
LISK_NODE_DIR="lisk-node-0.12.15-lisk"
LISK_NODE_FILE="$LISK_NODE_DIR.tar.gz"
LISK_NODE_URL="https://github.com/LiskHQ/lisk-node/archive/v0.12.15-lisk.tar.gz"
LISK_NODE_OUT="out/Release/node"
LISK_NODE_CONFIG=""

NODE_DIR="node-v0.12.15"
NODE_FILE="$NODE_DIR.tar.gz"
NODE_URL="https://nodejs.org/download/release/v0.12.15/$NODE_FILE"
NODE_OUT="compiled"
NODE_CONFIG=""
